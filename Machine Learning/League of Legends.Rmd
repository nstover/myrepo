...
```{r}
model_glm <- train(win ~.,data=training1, method = "glm", trControl = my_control1)
...
The first logistic regression model yields an 71.14% percent accuracy.
...
I am going to use a decision tree next. The decision tree yields a 75.15% accuracy. 


```{r}
dtree_fit <- train(win ~., data = training1, method = "rpart",
